...
FOREIGN KEY (PA_LNAME, PA_FNAME, PA_BIRTHDATE, PA_ZIPCODE) REFERENCES PATIENT(PA_LNAME, PA_FNAME, PA_BIRTHDATE, PA_ZIPCODE));

CREATE TABLE PROVIDER (
PRO_ID VARCHAR(25) NOT NULL,
PRO_LNAME VARCHAR(25) NOT NULL,
PRO_INITIAL VARCHAR(2) NULL,
...
FOREIGN KEY (AD_NAME, AD_ZIPCODE) REFERENCES ADSITE(AD_NAME, AD_ZIPCODE));

CREATE TABLE VACCINATION (
VACC_DOSENUM VARCHAR(35) NOT NULL,
VACC_TYPE VARCHAR(50) NULL,
VACC_CVX VARCHAR(5) NULL,
...
FOREIGN KEY (PA_LNAME, PA_FNAME, PA_BIRTHDATE, PA_ZIPCODE) REFERENCES PATIENT(PA_LNAME, PA_FNAME, PA_BIRTHDATE, PA_ZIPCODE),
FOREIGN KEY (VACC_DOSENUM, VACC_LOTNUM) REFERENCES VACCINATION(VACC_DOSENUM, VACC_LOTNUM));
